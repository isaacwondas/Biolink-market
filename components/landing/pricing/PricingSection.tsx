...
export default function PricingSection() {
  return (
    <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#041E12]">
      <div className="max-w-7xl mx-auto">
        {/* Heading */}
        <div className="mx-auto mb-16 max-w-2xl text-center space-y-4">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#22C55E]/30 bg-[#22C55E]/10 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#22C55E]">
            Simple Pricing
          </div>
          ...
          <p className="text-lg text-emerald-100/70 mt-4">
        ...
        <div className="relative mx-auto max-w-md overflow-hidden border border-emerald-900/60 bg-[#072919] rounded-2xl p-8 md:p-10 shadow-2xl transition-shadow duration-300">
          ...
          <div className="mt-8 flex items-end gap-2">
            ...
            <span className="pb-1 text-sm text-emerald-100/60">
              forever free
            </span>
          </div>
          ...
          <ul className="mt-10 space-y-4">
            {features.map((feature) => (
              <li key={feature} className="flex items-center gap-3">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#22C55E]/20 flex-shrink-0">
          ...
          <Link
            ...
            className="mt-10 flex w-full items-center justify-center rounded-xl bg-[#22C55E] hover:bg-[#16a34a] py-4 text-sm md:text-base font-bold text-white transition-all duration-200 hover:shadow-lg active:scale-[0.99]"
          >
